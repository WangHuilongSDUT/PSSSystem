...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String sql = String.format("select * from user where uName='%s' and password='%s'", txtUser.getText(), txtPassword.getText());
        ...
        try {
              ...
              if(rs.next())
             {
                 System.out.print(rs.getInt(1) + "\t");
                    ...
                    user.setuTele(""+rs.getString(5));
                    user.setuAddress(""+rs.getString(6));
                    user.setAuthority(""+rs.getInt(7));
                    user.setSex(""+rs.getString(8));
                    
                    user.setNativePlace(""+rs.getString(9));
